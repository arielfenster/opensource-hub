			...
			<div className='flex gap-8'>
				<Tabs defaultTab='personal'>
					<Tabs.List className='flex flex-1 flex-col'>
						<Tabs.Trigger name='personal'>PERSONAL INFO</Tabs.Trigger>
						<Tabs.Trigger name='security'>SECURITY INFO</Tabs.Trigger>
					</Tabs.List>
					<Tabs.ContentContainer className='h-60 w-60 flex-3 bg-purple-300'>
						<Tabs.Content name='personal'>im personal info</Tabs.Content>
						<Tabs.Content name='security'>im security info</Tabs.Content>
